// ─────────────────────────────────────────────────────────────────────────────
//  Tax Year Parameters (mirrors backend TaxYearParameter model)
// ─────────────────────────────────────────────────────────────────────────────
...
export interface EmploymentData {
    ...
    grossSalary: number
    lohnsteuerWithheld: number
    soliWithheld: number
    kirchensteuerWithheld: number
}
...
export interface TaxCalculationResult {
    ...
    aussergewoehnliche_belastungen: number
