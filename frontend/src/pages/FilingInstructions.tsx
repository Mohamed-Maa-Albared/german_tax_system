        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-brand-600 text-white rounded-lg text-sm font-medium hover:bg-brand-700 transition-colors shadow-sm print:hidden"
                >
                    <Download size={15} />
                    Save as PDF
                </button>
            ...
            <div className="flex gap-3 justify-center print:hidden">
                <button
                    onClick={() => window.print()}
                    className="flex items-center gap-2 px-6 py-2.5 bg-brand-600 text-white rounded-lg text-sm font-medium hover:bg-brand-700 transition-colors"
                >
                    <Download size={15} />
                    Save as PDF / Print
                </button>
